...
## Project 1:<button style="button border: none; color: blue;background: none;border-radius: 0%; font-size: 17px; animation: 2s" onhover="this.style.color: dark-blue" onclick="window.location.href = window.location.href + '/mrbank'">Mr. Bank</button>
