...
## Project 1:<button style="	border: none; color: blue;background: none;border-radius: 0%; font-size: 17px" onclick="window.location.href = window.location.href + '/mrbank'">Mr. Bank</button>
