...
## Project 1:<button style="border: none; color: blue;background: none;border-radius: 0%; font-size: 17px; transition: 2s" onmouseover="this.style = 'border: none; color: darkblue;background: none;border-radius: 0%; font-size: 17px; transition: 0.5s'" onmouseout="this.style = 'border: none; color: blue;background: none;border-radius: 0%; font-size: 17px; transition: 2s'" onclick="window.location.href = window.location.href + '/mrbank'">Mr. Bank</button>
